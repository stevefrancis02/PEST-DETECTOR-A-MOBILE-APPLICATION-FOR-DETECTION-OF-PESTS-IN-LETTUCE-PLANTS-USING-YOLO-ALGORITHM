...
public class  objectDetectorClass {
      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Imgproc.putText(rotated_mat_image,labelList.get((int) class_value) +" "+ score_value,new Point(left,top),3,1,new Scalar(255, 0, 0, 255),2);
            }

        }
        //returning rotate back by -90 degree
        Mat b=rotated_mat_image.t();
        Core.flip(b,mat_image,0);
        b.release();return mat_image;
    }
    ...
    private ByteBuffer convertBitmapToByteBuffer(Bitmap bitmap) {
        ...
        // for this quant=0
        // Change quant=1
        // As we are scaling image from 0-2k+ to 0-1
        int quant=1;
